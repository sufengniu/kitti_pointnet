...
from global_level_representation.modules import ConvLSTMCell, Sign
...
class Binarizer(nn.Module):
    def __init__(self):
        ...
        global_code_length = 32
        self.conv = nn.Conv2d(512, global_code_length, kernel_size=1, bias=False)
        self.sign = Sign()
