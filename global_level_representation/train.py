...
parser.add_argument(
    '--train', '-f', required=True, default='/scratch4/sniu/pc/pointnet_full_emd/code.h5', type=str, help='folder of training images')
parser.add_argument(
...
train_set = CompressDataset(filename=args.train)
...
import global_level_representation.network as network
...
for epoch in range(last_epoch + 1, args.max_epochs + 1):
    ...
    for batch, data in enumerate(train_loader):
        ...
        res = (patches - 0.5).permute(0,3,1,2)
        bp_t0 = time.time()
